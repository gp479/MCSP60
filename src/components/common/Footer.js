					  			...
					  			<Container>
										<Row>
										    ...
										    <Col lg={4} md={4} sm={6}>
										    	...
										    	<ul className="footerlinks">
										    		<li><a href="availableproperty">Property for Rent</a></li>
										    		<li><a href="availableproperty">Property for Sale</a></li>
										    		<li><a href="availableproperty">Resale Properties</a></li>
										    		<li><a href="availableproperty">Recent Properties	</a></li>
										    	</ul>
										    </Col>
										    <Col lg={4} md={4} sm={6}>
